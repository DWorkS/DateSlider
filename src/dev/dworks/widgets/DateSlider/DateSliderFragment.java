 ...
 */
public class DateSliderFragment extends DialogFragment {
...
//	private static String TAG = "DATESLIDER";
    ...
    public DateSliderFragment(Context context, int layoutID, OnDateSetListener l, Calendar initialTime) {
    	this(context,layoutID,l,initialTime, null, null, 1);
    }
    
    public DateSliderFragment(Context context, int layoutID, OnDateSetListener l, Calendar initialTime, int minInterval) {
    	this(context,layoutID,l,initialTime, null, null, minInterval);
    }
    
    public DateSliderFragment(Context context, int layoutID, OnDateSetListener l,
    ...
    private void initControls() {
        ...
        mTitleText = (TextView) root.findViewById(R.id.dateSliderTitleText);
        mContainer = (SliderContainer) root.findViewById(R.id.dateSliderContainer);
    ...
    private android.view.View.OnClickListener okButtonClickListener = new android.view.View.OnClickListener() {
        public void onClick(View v) {
            if (onDateSetListener!=null)
                onDateSetListener.onDateSet(DateSliderFragment.this, getTime());
            dismiss();
        }
    };
...
*/
    ...
    protected void setTitle() {
        if (mTitleText != null) {
            ...
            mTitleText.setText(getActivity().getApplicationContext().getString(R.string.dateSliderTitle) +
    ...
    public interface OnDateSetListener {
         ...
         *
         */
        public void onDateSet(DateSliderFragment view, Calendar selectedDate);
    }
}

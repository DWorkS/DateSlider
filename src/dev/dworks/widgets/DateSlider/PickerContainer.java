...
public class PickerContainer extends LinearLayout implements Button.OnClickListener,
    ...
    public PickerContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected int getLayoutId() {
        return R.layout.datetimeslider;
    }
    ...
    /*private class KeyboardPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            if (mDateFormatOrder[position] == DateFormat.MONTH) {
                ...
                for (int i = 0; i < 12; i++) {
                    mMonths[i].setOnClickListener(PickerContainer.this);
                ...
                for (int i = 0; i < 10; i++) {
                    mDateNumbers[i].setOnClickListener(PickerContainer.this);
                ...
                mDateRight.setBackgroundResource(mKeyBackgroundResId);
                mDateRight.setOnClickListener(PickerContainer.this);
                ...
                for (int i = 0; i < 10; i++) {
                    mYearNumbers[i].setOnClickListener(PickerContainer.this);

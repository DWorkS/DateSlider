...
public class PickerDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mTheme != -1) {
            ...
            mTextColor = a.getColorStateList(R.styleable.PickersDialogFragment_bpTextColor);
            mButtonBackgroundResId = a.getResourceId(R.styleable.PickersDialogFragment_bpButtonBackground,
                    mButtonBackgroundResId);
            mDividerColor = a.getColor(R.styleable.PickersDialogFragment_bpDividerColor, mDividerColor);
            mDialogBackgroundResId = a
                    .getResourceId(R.styleable.PickersDialogFragment_bpDialogBackground, mDialogBackgroundResId);
            a.recycle();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.picker_dialog, container, false);
